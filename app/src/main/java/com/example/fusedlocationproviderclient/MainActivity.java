...
import static com.example.fusedlocationproviderclient.GpsUtils.GPS_REQUEST;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.txtLocation = (TextView) findViewById(R.id.currentLoc);
        this.btnLocation = (Button) findViewById(R.id.btnLoc);
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                for (Location location : locationResult.getLocations()) {
                    if (location != null) {
                        ...
                        if (!isContinue) {
                            txtLocation.setText(wayLatitude + " Latitude " + wayLongitude + " Longitude");
                        }
